...
:::{.incremental}
1. Detail an (ongoing) application for text analysis.
2. Discuss possible approaches to addressing the problem.
:::
...
# What other cleaning and feature engineering should we consider? Why?
